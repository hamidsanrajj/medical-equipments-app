...
<div class="container-box">
    <div class="row">
        <div class="col-md-6">
            <img src="assets/images/oec-elite-imaging-system-mobile.avif" width=500 height= 500>
        </div>
        <div class="col-md-6">
            ...
            <table>
                ...
                <tr>
                    <td><b>Parts</b></td>
                    <td>the C-arm, a high-resolution flat panel detector (CFD), and various imaging and workflow enhancements</td>
                </tr>
                <tr>
                    <td><b>Types</b></td>
                    <td>OEC Elite CFD and the OEC Elite MiniView</td>
                </tr>
            </table>
